  ...
  return (
    <section className="relative h-[600px] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/images/hero-offers-website-maintenance.jpg"
          alt="Modern server room representing secure website maintenance and monitoring"
          fill
        ...
        <div className="max-w-6xl">
          ...
          <h1 className="font-heading text-4xl font-bold leading-tight tracking-tight text-primary-foreground sm:text-5xl lg:text-6xl xl:text-7xl">
            <span className="text-balance">
              Keep Your Practice Website{" "}
              <span className="text-primary">Secure & Always Online.</span>
            </span>
          </h1>

          <p className="mt-6 max-w-lg text-lg leading-relaxed text-primary-foreground/70">
            Your website is your digital front door. We handle the updates,
            security patches, backups, and monitoring so you can focus on
            patient care -- not tech headaches.
          </p>
