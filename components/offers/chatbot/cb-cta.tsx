      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center lg:px-8">
        <h2 className="font-heading text-3xl font-bold tracking-tight text-primary-foreground sm:text-4xl lg:text-5xl">
          <span className="text-balance">
            Ready to stop losing patients to voicemail and after-hours silence?
          </span>
        </h2>
        <p className="mx-auto mt-4 max-w-2xl text-lg leading-relaxed text-primary-foreground/70">
          Book a free strategy call and see exactly how an AI chatbot can
          capture more leads, book more appointments, and grow your practice
          on autopilot -- 24 hours a day, 7 days a week.
        </p>
        ...
        <p className="mt-6 text-sm text-primary-foreground/50">
          No obligation. See a live demo of your custom AI chatbot before you commit.
        </p>
      </div>
    </section>
  )
