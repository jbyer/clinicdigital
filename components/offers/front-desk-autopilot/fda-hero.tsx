    ...
    <section className="relative h-[600px] overflow-hidden pb-[30px]">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="AI voice assistant and chatbot handling patient calls and appointments"
          fill
        ...
        <div className="max-w-6xl">
          ...
          <h1 className="font-heading text-4xl font-bold leading-tight tracking-tight text-primary-foreground sm:text-5xl lg:text-6xl xl:text-7xl">
            <span className="text-balance">
              Your Front Desk Never <span className="text-primary">Sleeps Again</span>
            </span>
          </h1>

          <p className="mt-6 max-w-lg text-lg leading-relaxed text-primary-foreground/70">
            AI chatbots and voice assistants handle appointment booking, intake, and patient service 24/7—reducing workload on your team while keeping patients happy.
          </p>
