...
const highlights = [
  ...
  "Trained on your services & protocols",
  "Answers calls while you sleep",
]
  ...
  return (
    <section className="relative h-[600px] overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/images/hero-offers-voice-ai.jpg"
          alt="Modern medical office with AI voice assistant technology"
          fill
        ...
        <div className="max-w-2xl">
          ...
          <h1 className="font-heading text-4xl font-bold leading-tight tracking-tight text-primary-foreground sm:text-5xl lg:text-6xl xl:text-7xl">
            <span className="text-balance">
              ...
              <span className="text-primary">AI-Powered Voice Agents</span>
            </span>
          </h1>

          <p className="mt-6 max-w-lg text-lg leading-relaxed text-primary-foreground/70">
            ClinicDigital deploys an intelligent Voice AI agent that answers
            calls, handles inquiries, books appointments, and routes urgent
            matters to your team -- 24/7, without adding staff.
          </p>
