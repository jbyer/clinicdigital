...
const rows = [
  { feature: "24/7 call availability", generic: false, ai: true },
  ...
  { feature: "No hold times for callers", generic: false, ai: true },
  { feature: "Custom-trained on your practice", generic: false, ai: true },
  { feature: "CRM & workflow integration", generic: true, ai: true },
  { feature: "HIPAA-aware call handling", generic: false, ai: true },
  { feature: "Missed call follow-up", generic: true, ai: true },
...
export function VoiceAIComparison() {
  return (
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-3 font-heading text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            <span className="text-balance">
              Voicemail cannot compete with this.
            </span>
          </h2>
          <p className="mt-4 text-lg leading-relaxed text-muted-foreground">
            Traditional voicemail and answering services lose patients. Voice AI
            converts callers into booked appointments -- instantly, intelligently,
