const stats = [
  { value: "24/7", label: "Always-on call handling" },
  { value: "90%+", label: "Calls answered instantly" },
  { value: "40%", label: "Reduction in missed calls" },
  { value: "<2 Weeks", label: "Deployed and live" },
]

export function VoiceAITrustBar() {
  return (
